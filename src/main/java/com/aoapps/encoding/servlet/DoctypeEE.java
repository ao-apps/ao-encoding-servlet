...
public final class DoctypeEE {
  ...
  /**
   * Gets the doctype in effect for the request, or {@linkplain DoctypeEE#getDefault(javax.servlet.ServletContext) the default}
   * when not yet {@linkplain DoctypeEE#set(javax.servlet.ServletRequest, com.aoapps.encoding.Doctype) set}.
   *
   * <p>Once the default is resolved,
   * {@linkplain DoctypeEE#set(javax.servlet.ServletRequest, com.aoapps.encoding.Doctype) sets the request attribute}.</p>
   */
